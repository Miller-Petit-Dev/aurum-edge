"""
Script para generar todos los archivos del proyecto AURUM-EDGE v2
"""
import os
...
# Core modules
FILES_CONTENT['src/aurum_edge/core/__init__.py'] = '''"""Core utilities and configuration"""
...
FILES_CONTENT['src/aurum_edge/core/config.py'] = '''"""
